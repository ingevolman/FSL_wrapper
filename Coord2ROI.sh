...
if [[ -n $coord ]] ; then >&2 echo ""; >&2 echo "please provide coordinates with --coord"; usage; exit 1; fi
if [[ -n $dil ]] ; then >&2 echo ""; >&2 echo "please specify the dilation radius with --dil"; usage; exit 1; fi
